...
router.put('/users/:id', requireRole(...ALL_ADMIN_ROLES), adminActionLimiter, requirePermission('users:update'), asyncWrap(updateAccount));
router.delete('/users/:id', requireRole('superadmin'), adminActionLimiter, requirePermission('users:delete'), asyncWrap(deleteAccount));
router.patch('/users/:id/toggle', requireRole(...ALL_ADMIN_ROLES), adminActionLimiter, requirePermission('users:toggle'), asyncWrap(toggleAccountStatus));
router.get('/users/:id/record', requireRole(...ALL_ADMIN_ROLES), requirePermission('users:view'), asyncWrap(getStudentAcademicRecord));
