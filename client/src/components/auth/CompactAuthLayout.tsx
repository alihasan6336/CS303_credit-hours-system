...
const CompactAuthLayout: React.FC<CompactAuthLayoutProps> = ({
  title,
  subtitle,
  features,
  children,
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-gray-50">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          ...
          {/* Form Card with Scrollable Content */}
          <div className="bg-white rounded-2xl shadow-xl p-6 max-h-[calc(100vh-4rem)] overflow-y-auto">
            <div className="mb-4">
              ...
              <p className="mt-1 text-xs text-gray-600">{formSubtitle}</p>
            </div>
...
export default CompactAuthLayout;
